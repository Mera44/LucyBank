...
<div class="content-div">
	...
	<spring:message code="address.zipcode" var="zip"/>
		<form:form class="form-group" modelAttribute="teller" action="teller/update" method="post" >
				 <%-- <form:errors  path = "*"/>  --%>
		...
		<spring:message code="customer.profile" /><br />
			...
			<form:input class="form-control" id="email" path="profile.email" value="${editTeller.profile.email}"/>
			<form:errors style="color:red;" path="profile.email" />
			<label for="birthdate"></label>
			<form:input class="form-control" id="username" path="profile.userName" value="${editTeller.profile.userName}"/>
		...
		<div class="address">
			...
			<form:input class="form-control" id="street" path="profile.address.street" value="${editTeller.profile.address.street}"/>
			<form:errors style="color:red;" path="profile.address.street" />
			<label for="street"></label>
			<form:input class="form-control" id="street" path="profile.address.state" value="${editTeller.profile.address.state}"/>
			<form:errors style="color:red;" path="profile.address.state" />
			<label for="street"></label>
			<form:input class="form-control" id="street" path="profile.address.zipcode" value="${editTeller.profile.address.zipcode}"/>
		...
		<div class="submmit-button">
			<input class="btn btn-primary" type="submit" value="Update Teller" />
		</div>
		</form:form>
</div>
</body>
